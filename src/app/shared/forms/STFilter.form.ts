  ...
  template: `
    <form class="form-control full-width" [formGroup]="form!">
      ...
      <div class="form-input">
        ...
        <ngx-slider
          [options]="imports.DistanceSliderConfig"
          formControlName="if_$radius"
        ></ngx-slider>
      </div>
      ...
      <div class="form-input">
        ...
        <ngx-slider
          [options]="imports.SalarySliderConfig"
          [value]="0"
          [highValue]="100000"
          formControlName="if_amount"
        ></ngx-slider>
      </div>
    ...
    this.create<{
      ...
      this.defineComputedProperty("$employeeCount", (post) => {
        const company = this.store.selectSnapshot(
          ...
          jobsForCompany = this.store.selectSnapshot(
            DataQueries.getMany("JobForCompany", company.jobs)
          );
      ...
      this.some(
        ...
        this.onlyIf(
          "$employeeCount",
          (count) => 1 <= count && count <= 10,
          [],
          true
        ),
        this.onlyIf(
          "$employeeCount",
          (count) => count > 10 && count <= 25,
          [],
          true
        ),
        this.onlyIf(
          "$employeeCount",
          (count) => count > 25 && count <= 50,
          [],
          true
        ),
        this.onlyIf(
